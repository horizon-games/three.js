...
(function (global, factory) {
	...
	function TextureCubeUVNode( uv, textureSize, bias ) {
		...
		TempNode_js.TempNode.call( this, 'TextureCubeUVData' ); // TextureCubeUVData is type as StructNode
	...
	TextureCubeUVNode.Nodes = ( function () {
		...
		var getFaceFromDirection = new FunctionNode_js.FunctionNode( [
		...
		var cubeUV_maxLods1 = new ConstNode_js.ConstNode( "#define cubeUV_maxLods1 ( log2( cubeUV_textureSize * 0.25 ) - 1.0 )" );
		var cubeUV_rangeClamp = new ConstNode_js.ConstNode( "#define cubeUV_rangeClamp ( exp2( ( 6.0 - 1.0 ) * 2.0 ) )" );

		var MipLevelInfo = new FunctionNode_js.FunctionNode( [
		...
		var cubeUV_maxLods2 = new ConstNode_js.ConstNode( "#define cubeUV_maxLods2 ( log2( cubeUV_textureSize * 0.25 ) - 2.0 )" );
		var cubeUV_rcpTextureSize = new ConstNode_js.ConstNode( "#define cubeUV_rcpTextureSize ( 1.0 / cubeUV_textureSize )" );

		var getCubeUV = new FunctionNode_js.FunctionNode( [
		...
		var cubeUV_maxLods3 = new ConstNode_js.ConstNode( "#define cubeUV_maxLods3 ( log2( cubeUV_textureSize * 0.25 ) - 3.0 )" );

		var textureCubeUV = new FunctionNode_js.FunctionNode( [
