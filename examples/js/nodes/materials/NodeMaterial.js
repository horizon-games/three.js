...
(function (global, factory) {
	...
	function NodeMaterial( vertex, fragment ) {
		...
		this.vertex = vertex || new RawNode_js.RawNode( new PositionNode_js.PositionNode( PositionNode_js.PositionNode.PROJECTION ) );
		this.fragment = fragment || new RawNode_js.RawNode( new ColorNode_js.ColorNode( 0xFF0000 ) );
	...
	NodeMaterial.prototype.build = function ( params ) {
		...
		var builder = params.builder || new NodeBuilder_js.NodeBuilder();
