...
(function (global, factory) {
	...
	function StandardNode() {
		...
		this.color = new ColorNode_js.ColorNode( 0xFFFFFF );
		this.roughness = new FloatNode_js.FloatNode( 1 );
		this.metalness = new FloatNode_js.FloatNode( 0 );
	...
	StandardNode.prototype.build = function ( builder ) {
		...
		if ( builder.isShader( 'vertex' ) ) {
			...
			var specularRoughness = new ExpressionNode_js.ExpressionNode( 'material.specularRoughness', 'f' );
			var clearcoatRoughness = new ExpressionNode_js.ExpressionNode( 'material.clearcoatRoughness', 'f' );

			var contextEnvironment = {
				roughness: specularRoughness,
				bias: new SpecularMIPLevelNode_js.SpecularMIPLevelNode( specularRoughness ),
				viewNormal: new ExpressionNode_js.ExpressionNode( 'normal', 'v3' ),
				worldNormal: new ExpressionNode_js.ExpressionNode( 'inverseTransformDirection( geometry.normal, viewMatrix )', 'v3' ),
				gamma: true
			};
			...
			var contextClearcoatEnvironment = {
				...
				bias: new SpecularMIPLevelNode_js.SpecularMIPLevelNode( clearcoatRoughness ),
				viewNormal: new ExpressionNode_js.ExpressionNode( 'clearcoatNormal', 'v3' ),
				worldNormal: new ExpressionNode_js.ExpressionNode( 'inverseTransformDirection( geometry.clearcoatNormal, viewMatrix )', 'v3' ),
				gamma: true
			};
