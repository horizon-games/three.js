...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/nodes/core/Node.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/nodes/core/Node.js'], factory) :
	...
	TempNode.prototype = Object.create( Node_js.Node.prototype );
	...
	TempNode.prototype.build = function ( builder, output, uuid, ns ) {
		...
		if ( this.getShared( builder, output ) ) {
			...
			if ( builder.analyzing ) {
				...
				return Node_js.Node.prototype.build.call( this, builder, output, uuid );

			} else if ( isUnique ) {

				data.name = data.name || Node_js.Node.prototype.build.call( this, builder, output, uuid );
