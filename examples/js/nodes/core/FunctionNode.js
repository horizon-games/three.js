...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/nodes/core/TempNode.js'), require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/nodes/core/NodeLib.js')) :
	typeof define === 'function' && define.amd ? define(['exports', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/nodes/core/TempNode.js', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/nodes/core/NodeLib.js'], factory) :
	...
	function FunctionNode( src, includes, extensions, keywords, type ) {
		...
		TempNode_js.TempNode.call( this, type );
	...
	FunctionNode.prototype.generate = function ( builder, output ) {
		...
		for ( var i = 0; i < matches.length; i ++ ) {
			...
			if ( this.keywords[ prop ] || ( this.useKeywords && isGlobal && NodeLib_js.NodeLib.containsKeyword( prop ) ) ) {

				var node = this.keywords[ prop ];

				if ( ! node ) {

					var keyword = NodeLib_js.NodeLib.getKeywordData( prop );

					if ( keyword.cache ) node = builder.keywords[ prop ];

					node = node || NodeLib_js.NodeLib.getKeyword( prop, builder );
			...
			if ( this.getIncludeByName( reference ) === undefined && NodeLib_js.NodeLib.contains( reference ) ) {

				builder.include( NodeLib_js.NodeLib.get( reference ) );
