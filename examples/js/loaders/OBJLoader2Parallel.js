...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/worker/main/WorkerExecutionSupport.js'), require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/utils/CodeSerializer.js'), require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/OBJLoader2.js'), require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/worker/parallel/OBJLoader2Parser.js'), require('/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/worker/parallel/WorkerRunner.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/worker/main/WorkerExecutionSupport.js', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/utils/CodeSerializer.js', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/OBJLoader2.js', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/worker/parallel/OBJLoader2Parser.js', '/Users/tomaszdysinski/Repositories/three.js/examples/jsm/loaders/obj2/worker/parallel/WorkerRunner.js'], factory) :
	...
	OBJLoader2Parallel.prototype = Object.assign( Object.create( OBJLoader2_js.OBJLoader2.prototype ), {
		...
		buildWorkerCode: function () {
			...
			if ( codeBuilderInstructions.isSupportsStandardWorker() ) {
				...
				let objectManipulator = new WorkerRunner_js.ObjectManipulator();
				let defaultWorkerPayloadHandler = new WorkerRunner_js.DefaultWorkerPayloadHandler( this.parser );
				let workerRunner = new WorkerRunner_js.WorkerRunner( {} );
				codeBuilderInstructions.addCodeFragment( CodeSerializer_js.CodeSerializer.serializeClass( OBJLoader2Parser_js.OBJLoader2Parser, this.parser ) );
				codeBuilderInstructions.addCodeFragment( CodeSerializer_js.CodeSerializer.serializeClass( WorkerRunner_js.ObjectManipulator, objectManipulator ) );
				codeBuilderInstructions.addCodeFragment( CodeSerializer_js.CodeSerializer.serializeClass( WorkerRunner_js.DefaultWorkerPayloadHandler, defaultWorkerPayloadHandler ) );
				codeBuilderInstructions.addCodeFragment( CodeSerializer_js.CodeSerializer.serializeClass( WorkerRunner_js.WorkerRunner, workerRunner ) );
