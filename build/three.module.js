...
var clipping_planes_pars_fragment = "#if NUM_CLIPPING_PLANES > 0 || defined( USE_DITHERED_HOLE )\nvarying vec3 vClipPosition;\n#endif\n#if NUM_CLIPPING_PLANES > 0\n\tuniform vec4 clippingPlanes[ NUM_CLIPPING_PLANES ];\n#endif";

var clipping_planes_pars_vertex = "#if NUM_CLIPPING_PLANES > 0 || defined( USE_DITHERED_HOLE )\n\tvarying vec3 vClipPosition;\n#endif";

var clipping_planes_vertex = "#if NUM_CLIPPING_PLANES > 0 || defined( USE_DITHERED_HOLE )\n\tvClipPosition = - mvPosition.xyz;\n#endif";

var dithered_clipping_hole_fragment = "#ifdef USE_DITHERED_HOLE\nvec2 ditherCoord = gl_FragCoord.xy;\nditherCoord.y -= mod(ditherCoord.x, 2.0);\nfloat holeDist = length(vPosition.xy / (vPosition.w) - ditheredHole.xy);\nvec2 dither = mod(ditherCoord, 2.0) * 0.15;\nholeDist /= ditheredHole.z;\nholeDist *= holeDist * holeDist;\nholeDist *= ditheredHole.z;\nholeDist += (dither.x + dither.y * 2.0);\nfloat pDepth = gl_FragCoord.z / gl_FragCoord.w;\nif(holeDist < ditheredHole.z && pDepth < ditheredHole.w) discard;\n#endif";

var dithered_clipping_hole_pars_fragment = "#ifdef USE_DITHERED_HOLE\n  uniform vec4 ditheredHole;\n  varying vec4 vPosition;\n#endif";

var dithered_clipping_hole_vertex = "#ifdef USE_DITHERED_HOLE\n  vPosition = gl_Position;\n  vPosition.x /= projectionMatrix[0][0] * 0.8;\n#endif";

var dithered_clipping_hole_pars_vertex = "#ifdef USE_DITHERED_HOLE\n  varying vec4 vPosition;\n#endif";
